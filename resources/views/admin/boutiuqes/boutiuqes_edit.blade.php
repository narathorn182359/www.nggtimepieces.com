...
<div class="content-wrapper">
    ...
    <div class="col-md-6">
      ...
      <div class="box box-danger">
        ...
        <form role="form" action="{{route('edit_boutiuqes',Crypt::encrypt($boutiuqes->id_boutiuqes))}}"   method="POST">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <div class="box-body">
                  <div class="form-group">
                    <label for="name_boutiuqes">ชื่อ</label>
                  <input type="text" class="form-control" id="name_boutiuqes" name="name_boutiuqes" value="{{$boutiuqes->name_boutiuqes}}">
                  </div>
                  <textarea id="boutiuqes_detail" name="boutiuqes_detail" rows="10" cols="80"  name="">
                    {{$boutiuqes->boutiuqes_detail}}
           </textarea>
